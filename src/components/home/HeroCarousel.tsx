...
export default function HeroCarousel() {
  const [activeIndex, setActiveIndex] = useState(1); // empezamos con Quito al centro
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Descubre Ecuador como
              <span className="block">nunca antes</span>
            </h1>
            <p className="mt-2 text-sm md:text-base text-slate-100 max-w-xl">
              Tours seleccionados, guías expertos y experiencias seguras
            </p>
          </div>
